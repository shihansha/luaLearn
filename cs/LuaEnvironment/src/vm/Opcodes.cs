...
internal class OpCodeInfo
{
    ...
    public readonly static OpCodeInfo[] OpCodeInfos = new OpCodeInfo[]
    {
        ...
        new OpCodeInfo(0, 0, OpArgType.OpArgN, OpArgType.OpArgU, OpFormat.IABC, "TFORCALL", VM.TForCall),
        new OpCodeInfo(0, 1, OpArgType.OpArgR, OpArgType.OpArgN, OpFormat.IAsBx, "TFORLOOP", VM.TForLoop),
